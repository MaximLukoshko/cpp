...
void CountResidualVector(Function func, int NumberOfEquations, DiffEq* ArrSourceEq,
...
void CountMatrixJakobi(double** Jakobi, Function funk, int NumberOfEquations,
